      ...
      this.camera.getPicture(this.cameraOptions).then((imageData1) => {
        ...
        if (this.photo1 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo1 = this.postDataService.apiServer_url + this.photoID.file_path
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData2) => {
        ...
        if (this.photo2 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo2 = this.postDataService.apiServer_url + this.photoID.file_path
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData3) => {
        ...
        if (this.photo3 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo3 = this.postDataService.apiServer_url + this.photoID.file_path
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData4) => {
        ...
        if (this.photo4 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo4 = this.postDataService.apiServer_url + this.photoID.file_path
            console.log(this.photo1);
            this.status4 = "2"
            this.checktakeback();
            this.isTake4 = false;
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData5) => {
        ...
        if (this.photo5 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo5 = this.postDataService.apiServer_url + this.photoID.file_path
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData6) => {
        ...
        if (this.photo6 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo6 = this.postDataService.apiServer_url + this.photoID.file_path
            console.log(this.photo1);
            this.status6 = "2"
            this.checklist();
            this.isTake6 = false;
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData7) => {
        ...
        if (this.photo7 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo7 = this.postDataService.apiServer_url + this.photoID.file_path
            console.log(this.photo1);
            this.status7 = "2"
            this.checklist();
            this.isTake7 = false;
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData8) => {
        ...
        if (this.photo8 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo8 = this.postDataService.apiServer_url + this.photoID.file_path
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData9) => {
        ...
        if (this.photo9 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo9 = this.postDataService.apiServer_url + this.photoID.file_path
            console.log(this.photo1);
            this.status9 = "2"
            this.checklist();
            this.isTake9 = false;
      ...
      this.camera.getPicture(this.cameraOptions).then((imageData10) => {
        ...
        if (this.photo10 == null || "") {
          ...
          this.postDataService.SaveCaseAll(params).then(photoID => {
            ...
            this.photo10 = this.postDataService.apiServer_url + this.photoID.file_path
