  ...
  checktakeback() {
    if (this.jobtype == "INSTALL") {
      if (this.status1 && this.status2 != "") {
        ...
        this.postDataService.postTranid(this.tran).then(tran => {
          console.log(tran);
        });
      }
    }
  ...
  async check() {
    ...
    if (this.jobtype == "CM") {
      ...
      modal.onDidDismiss().then(data => {
        ...
        console.log(this.idnew + "  &  " + this.idold)
        this.isenabledsig = true;
      })
